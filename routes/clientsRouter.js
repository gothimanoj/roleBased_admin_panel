...
router.get("/getAllRequestForDeveloper/:id",auth,clientsCtrl.getAllRequestForDeveloper);
router.get("/getDetailsForRequestedDeveloper/:id",auth,clientsCtrl.getDetailsForRequestedDeveloper);
